...
function talkView() {
  main.innerHTML = title(3, 'Thuyết trình & trả lời câu hỏi', 'Chuẩn bị hai video trong cùng một chặng. Em có thể xem và luyện trước; khi đã có đủ hai video, bấm nút Nộp bài ở cuối trang để nộp cả hai trong một lần.') +
